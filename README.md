...
Go to https://share.streamlit.io (Streamlit Community Cloud — free).
Connect your GitHub repo, point it at `app.py`.
Add your `ANTHROPIC_API_KEY` under the app's "Secrets" settings (never commit it to GitHub directly).
Deploy. You'll get a public URL like `https://yourname-sales-ai.streamlit.app`.
